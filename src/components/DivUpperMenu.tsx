...
function DivUpperMenu() {
    ...
    return (
        <>
            ...
            <div className=" flex bg-[#FFD580] justify-around  md:hidden">
                <div className=" size-18  ">
                    <ImageButton src={fotoflecha} alt="icono flecha" />
                </div>
                <div>
                    <MenuText text="MOSTRAR VEHICULOS" />
                </div>
